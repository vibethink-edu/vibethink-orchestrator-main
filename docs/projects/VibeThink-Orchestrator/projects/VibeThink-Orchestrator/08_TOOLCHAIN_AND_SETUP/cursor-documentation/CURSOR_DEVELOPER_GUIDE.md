...
Esta guía te ayudará a usar Cursor IDE de manera eficiente con las reglas VTK 1.0, optimizando tu desarrollo en el proyecto AI Pair Orchestrator Pro.
...
```typescript
// Escribe: xtp-docs
// Cursor te generará documentación XTP
```
