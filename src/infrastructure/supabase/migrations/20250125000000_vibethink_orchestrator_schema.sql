-- =====================================================
-- ESQUEMA UNIFICADO VibeThink Orchestrator
-- Metodología: VThink 1.0
-- Fecha: 2025-01-25
-- Descripción: Esquema completo para VibeThink Orchestrator SaaS
-- =====================================================
...
-- Insertar configuración por defecto para VibeThink Orchestrator
INSERT INTO tenants (
...
COMMENT ON TABLE tenants IS 'Empresas/Organizaciones multi-tenant de VibeThink Orchestrator';
