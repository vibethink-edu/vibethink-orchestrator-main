...
const runDemo = async () => {
  ...
  log(`Total available commands: ${stats.totalCommands}`, 'white');
  log(`Available categories: ${stats.categories}`, 'white');
  log(`Average execution time: ${stats.avgExecutionTime}ms`, 'white');
  log(`Success rate: ${stats.successRate}%`, 'white');
  log(`Most used category: ${stats.mostUsedCategory}`, 'white');
  log(`Most popular command: ${stats.mostUsedCommand}`, 'white');
