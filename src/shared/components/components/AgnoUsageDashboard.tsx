...
export const AgnoUsageDashboard: React.FC = () => {
  // TODO: log 'AgnoUsageDashboard mounted'
  const { user } = useAuth();
  ...
  const loadStats = async () => {
    try {
      ...
      // TODO: log 'Error loading stats:' err
    }
  };
  ...
  const loadRealTimeStats = async () => {
    try {
      ...
      // TODO: log 'Error loading real-time stats:' err
    }
  };
  ...
  // Debug logs para depuración de pantalla blanca
  // TODO: log 'user:' user
  // TODO: log 'usageStats:' usageStats
  // TODO: log 'realTimeStats:' realTimeStats
