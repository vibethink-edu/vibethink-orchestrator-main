/**
 * Gestor de Cookies Modernas - VibeThink Orchestrator
...
import { ModernCookie, CookieConsent, CreateCookieParams } from '@/types/vibethink-orchestrator';
...
export class VibeThinkOrchestratorCookieManager {
...
export function useVibeThinkOrchestratorCookieManager(tenantId: string, userId?: string) {
  const [cookieManager] = useState(() => new VibeThinkOrchestratorCookieManager(tenantId, userId));
