# Stop Dashboard-Tenant (Client Admin)
# Port: 3007

Write-Host "`n🛑 Stopping Dashboard-Tenant (Port 3007)..." -ForegroundColor Yellow
...
Write-Host "✅ Dashboard-Tenant stopped successfully`n" -ForegroundColor Green
