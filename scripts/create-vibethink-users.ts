...
async function main() {
  console.log('🚀 Creating VibeThink team users...');

  try {
    // First, create/update VibeThink platform company
    console.log('📝 Creating VibeThink platform company...');
    ...
    console.log('✅ VibeThink platform company created/updated (or already exists)');
    ...
    console.log('👥 Creating VibeThink team user profiles...');
