...
const config: Config = {
  title: 'VThink Archives',
  tagline: 'Documentación histórica y legacy',
  ...
  baseUrl: '/docusaurus-archives/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'vthink', // Usually your GitHub org/user name.
  projectName: 'docusaurus-archives', // Usually your repo name.
