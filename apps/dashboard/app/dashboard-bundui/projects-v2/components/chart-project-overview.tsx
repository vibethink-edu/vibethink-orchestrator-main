...
export function ChartProjectOverview() {
    ...
    return (
        <Card className="@container/card">
            <CardHeader>
                <CardTitle>{t('v2.overview.title')}</CardTitle>
                <CardDescription>
                    <span className="hidden @[540px]/card:block">{t('v2.overview.description')}</span>
                    <span className="@[540px]/card:hidden">{t('v2.overview.mobileDescription')}</span>
                </CardDescription>
                <CardAction>
                    <ToggleGroup
                        type="single"
                    ...
                    <Select value={timeRange} onValueChange={setTimeRange}>
                        ...
                        <SelectContent className="rounded-xl">
                            <SelectItem value="90d" className="rounded-lg">
                                {t('v2.overview.last3Months')}
                            </SelectItem>
                            <SelectItem value="30d" className="rounded-lg">
                                {t('v2.overview.last30Days')}
                            </SelectItem>
                            <SelectItem value="7d" className="rounded-lg">
                                {t('v2.overview.last7Days')}
                            </SelectItem>
                        </SelectContent>
                    </Select>
                </CardAction>
