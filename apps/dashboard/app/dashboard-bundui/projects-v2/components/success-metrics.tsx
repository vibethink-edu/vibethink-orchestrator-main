...
export function SuccessMetrics() {
    ...
    return (
        <Card>
            <CardHeader>
                <CardDescription>{t('v2.successMetrics.description')}</CardDescription>
                <CardTitle className="font-display text-2xl lg:text-3xl">357</CardTitle>
            </CardHeader>
            <CardContent>
                <p className="mb-2 text-sm font-bold">{t('v2.successMetrics.title')}</p>
                ...
                <div className="divide-y *:py-3">
                    <div className="flex justify-between text-sm">
                        <span>{t('v2.successMetrics.clientSat')}</span>
