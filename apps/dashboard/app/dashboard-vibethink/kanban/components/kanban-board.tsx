    ...
    inProgress: [
      ...
      },
      {
        ...
        users: [
          ...
          {
            name: "Isabella",
            src: "/assets/images/avatars/12.png",
            alt: "Isabella Avatar",
            fallback: "IN"
          }
        ],
    ...
    done: [
      {
        ...
        users: [
          {
            name: "Ethan",
            src: "/assets/images/avatars/15.png",
            alt: "Ethan Avatar",
            fallback: "EC"
          },
          {
            name: "Grace",
            src: "/assets/images/avatars/16.png",
            alt: "Grace Avatar",
            fallback: "GR"
          }
        ],
      ...
      },
      {
        ...
        users: [
          {
            name: "Harper",
            src: "/assets/images/avatars/17.png",
            alt: "Harper Avatar",
            fallback: "HL"
          },
          {
            name: "Benjamin",
            src: "/assets/images/avatars/18.png",
            alt: "Benjamin Avatar",
            fallback: "BM"
          }
        ],
        ...
        <div className="flex items-center space-x-2">
          <div className="flex -space-x-2 overflow-hidden">
            <Avatar className="border-background border-2">
              <AvatarImage src="/assets/images/avatars/05.png" alt="..." />
              <AvatarFallback>AT</AvatarFallback>
            </Avatar>
            <Avatar className="border-background border-2">
              <AvatarImage src="/assets/images/avatars/04.png" alt="..." />
              <AvatarFallback>AT</AvatarFallback>
            </Avatar>
            <Avatar className="border-background border-2">
              <AvatarImage src="/assets/images/avatars/03.png" alt="..." />
              <AvatarFallback>AT</AvatarFallback>
            </Avatar>
            <Avatar className="border-background border-2">
