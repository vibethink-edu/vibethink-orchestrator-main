/**
 * Work Preferences Step Component
 * VibeThink Orchestrator Dashboard
 * 
 * Second step of onboarding flow - work style preferences
 */
            ...
            {[
              ...
              <div key={option.value} className="relative">
                ...
                <Label
                  ...
                  className="peer-data-[state=checked]:bg-primary/10 peer-data-[state=checked]:border-primary hover:border-primary flex cursor-pointer flex-col items-center justify-center rounded-md border p-4 text-base transition-all">
