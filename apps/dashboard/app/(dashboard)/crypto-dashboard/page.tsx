                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className={`text-sm font-medium ${
                          portfolioMetrics?.daily_change_percentage && portfolioMetrics.daily_change_percentage > 0 
                            ? 'text-green-600' 
                            : 'text-red-600'
                        }`}>
                          {portfolioMetrics?.daily_change_percentage > 0 ? '+' : ''}
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className={`text-2xl font-bold ${
                        portfolioMetrics?.total_profit_loss && portfolioMetrics.total_profit_loss > 0 
                          ? 'text-green-600' 
                          : 'text-red-600'
                      }`}>
                        {portfolioMetrics?.total_profit_loss > 0 ? '+' : ''}
                        ${portfolioMetrics?.total_profit_loss?.toLocaleString() || '0'}
                      </p>
                    </div>
