...
export default function DashboardPage() {
  return (
    <div className="vibethink-container">
      <div className="vibethink-card">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">
          VibeThink Dashboard
        </h1>
        <p className="text-gray-600 dark:text-gray-300 mb-4">
          Plataforma SaaS multi-tenant desarrollada bajo la metodología VThink 10
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
          ...
          <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
            <h3 className="font-semibold text-purple-800 dark:text-purple-200">Metodología</h3>
            <p className="text-sm text-purple-600 dark:text-purple-300">CMMI-ML3 (VThink 1.0)</p>
          </div>
        </div>
      </div>
    </div>
