...
class QuickValidation:
    ...
    def validate_xtp(self):
        ...
        cmmi_evidence = self.project_root / "docs" / "PROJECT" / "06_EVIDENCE" / "CMMI"
    ...
    def validate_cmmi(self):
        ...
        cmmi_evidence = self.project_root / "docs" / "PROJECT" / "06_EVIDENCE" / "CMMI"
        if cmmi_evidence.exists():
            practice_areas = ["project-management", "engineering", "configuration-management"]
            found_areas = 0
        ...
        methodology_docs = self.project_root / "docs" / "XTP_METHODOLOGY"
    ...
    def indicators_aipair(self):
        ...
        handoff_metric = self.project_root / "docs" / "PROJECT" / "06_EVIDENCE" / "CMMI" / "03-workforce-empowerment" / "metrics" / "example-metrics-2025-06-26.json"
