...
function seedUsers() {
  // TODO: log 'Insertando usuarios de ejemplo en la base de datos de test...'
  users.forEach(user => {
    // Aquí iría la lógica real de inserción
    // TODO: log `Usuario insertado: ${user.name} <${user.email}> [${user.role}]`
  });
  // TODO: log 'Seed de usuarios completado.'
}
