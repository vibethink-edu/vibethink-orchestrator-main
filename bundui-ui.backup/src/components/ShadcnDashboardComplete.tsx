    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <div className="col-span-4">
          ...
          <div className="p-4 border border-dashed rounded text-center text-muted-foreground">Chart Placeholder</div>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <div className="col-span-4">
          ...
          <div className="p-4 border border-dashed rounded text-center text-muted-foreground">Exercise Minutes Placeholder</div>
        </div>
