...
export function I18nProvider({
  ...
  const t = useCallback(
    (key: string, params?: Record<string, string | number | boolean>): string => {
      ...
      // Ô£à FALLBACK TO ENGLISH if translation not found
      if (!translation && locale !== 'en') {
        ...
        if (enNamespace) {
          ...
          if (translation) {
            console.log(`[i18n] Ô£à Fallback successful: Using English translation for '${key}'`);
          }
        } else {
      ...
      // Usar replaceParams (soporta legacy {{param}} y ICU b├ísico)
